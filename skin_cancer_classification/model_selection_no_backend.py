...
# Global variables
ID = 55  # identifier for this simulation - use effnet as backend using val acc instead of AUC (23)
...
def objective(trial):  # uses effnet
    ...
    dropout_rate = trial.suggest_float("dropout", 0.5, 0.95)
